...
if it doesn't fit inside the plant.
...
process problem into a technical solution, a price and ultimately a proposal.

Preparing those proposals involves a lot of repeated work. That is why I started
building many software tools of my own.
...
When rock comes out of a mine, it usually needs to be processed before it
becomes a useful product. A mineral-processing plant separates the valuable
minerals from the waste rock.
...
company, plant and process data are all made up.
...
The client sends us an RFQ or request for quotation. It may include process
conditions, drawings and installation details. Almost every RFQ also raises
questions. Some information is missing, unclear or probably out of date.
...
But that only answers part of the problem.
...
The process data may tell us what size the sampler needs to be, but it cannot
tell us whether that sampler will physically fit.
...
A proposal may stay under review for months. On an early study, it could be
years before the project reaches construction. Some proposals never become
orders.

If the client does place the order, the work moves into project delivery. A
project manager normally coordinates the equipment through design, manufacturing
and delivery.
...
Site visits make better footage, but they are not a normal day for me. Most of
my time goes into meetings, emails, process data, spreadsheets and proposal
...
useful part of the job is knowing what I can answer myself vs knowing when I
need help and following up until the proposal can move forward.

## Why I started building tools

_Show a synthetic workflow spread across an RFQ, email, notes, a spreadsheet and
a proposal. Copy one invented value between documents and track a missing
question. Then briefly show a clean demo interface and a few seconds of code. Do
not show a work repository._

Overtime you realize there are a lot of repeated steps in these kinds of jobs.
We review RFQs, pull out important information, chase missing answers,
coordinate pricing and build another relativelty standard Word doc.

The equipment and technical problem change, but many of those steps repeat.

I have been coding for about eight years and I've built a personal finance
tracker, a mineral-processing app and several small tools for my own work. When
I run into the same annoying task every week, I start wondering if a small tool
could handle part of it.

Some of those tools help. Others become too complicated and need to be cut back.
I want to show both sides on this channel, including where AI is useful and
where I do not trust it in engineering work.

## Closing

_Talking head._

So that is my job. Getting the equipment to work on paper is only the start. It
also has to fit inside a real plant and make sense commercially. That is the
work I want to show here, including the tools I build when the paperwork starts
repeating. What part of that process would you want to see up close? Put your
